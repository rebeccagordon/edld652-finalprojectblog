...
description: |
  The relationship between student reading outcomes and district property tax revenue for race and ethnicity subgroups was evaluated for a subset of four states, representing every US Census region. 
author:
  - name: Amy Warnock
date: 2022-03-13
output:
...
-  Fitted linear regression lines by student race/ethnicity subgroup with scatterplot retained, using transparency and color to emphasize fitted lines
...
-  California: There appears to be a positive relationship between district revenue from property taxes and the percent of students attaining proficiency on reading assessments for all student subgroups. Overall, the strength of this relationship appears similar but is perhaps somewhat stronger for students reported as Asian/Pacific Islander and weaker in strength for students reported as American Indian/Alaska Native. 
-  Michigan: The fitted lines for White, Hispanic/Latino, and American Indian/Alaska Native subgroups have slight positive slopes, indicating that percent proficiency for these subgroups does not increase based on an increase in funding from property taxes. The fitted lines for Black and Asian/Pacific Islander subgroups are steeper, indicating a stronger association. 
-  Louisiana: There appears to be a moderate positive association between property tax revenue for all student subgroups except students reported as American Indian/Alaska Native. It appears that the percentage of American Indian/Alaska Native students scoring at or above proficient on reading assessments does not increase with an increase in funding from property taxes.
...
-  From the broad exploration, I narrowed the scope to one state from each US Census region. Prior Version 2 displays the relationship between district revenue from property taxes and outcomes of student race/ethnicity subgroups for districts in the state of California. I tried a color palette from the Wes Anderson palette.
-  Unlike the color palette I used for the bar plots, this color palette was not colorblind-friendly (Prior Version 3). 
-  Between this version and the final version, I shifted to using the Okabe Ito palette, adjusted the color and transparency of the scatterplot points, removed the outlines from the points, and refined the color legend. 
