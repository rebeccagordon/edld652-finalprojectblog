---
title: "geom_jitter: mean test score by students' subgroup and test(math or reading) by state"
description: |
...
- Design choices: 
	...
	- faceted by state
	- Only used the mean proficiency scores for each
	- Expanded height and width to accommodate the data
- Findings: No patterns emerged expect math scores were on average lower than reading scores.
