---
title: "geom_point: mean test score by subgroup and test"
description: |
...
- Design choices: 
	...
	- faceted by subgroup
	- Minimized size of points on the plot
	- Expanded height and width to accommodate the data
- Findings: For nearly all states, homeless students scored 50% or lower in proficiency. 
- Prior version: I initially found this plot to not be very informative. However, when I made the points smaller I noticed that there was a pattern among students by subgroup.
...
```{r rebecca-plots, fig.height=20, fig.width=15, echo=FALSE}
...
```{r rebecca-plot-prior, echo=FALSE}
#Plot showing mean test score by subgroup and test
...
```{r rebecca-plot-code, fig.show='hide'}
#Plot showing mean test score by subgroup and test
